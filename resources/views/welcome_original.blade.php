...
<section class="bg-light page-section" id="team">
    <div class="container">
        ...
        <div class="col-md-12 mx-auto">
            <a class="btn btn-primary" data-toggle="collapse" href="#{{str_replace(' ','','fctminister')}}" role="button" aria-expanded="false" aria-controls="minister">FCT MINISTER</a>
            <a class="btn btn-primary" data-toggle="collapse" href="#{{str_replace(' ','','senator')}}" role="button" aria-expanded="false" aria-controls="minister">Senator</a>
            <a class="btn btn-primary" data-toggle="collapse" href="#{{str_replace(' ','','houseofrep')}}" role="button" aria-expanded="false" aria-controls="minister">House of Rep</a>
            <a class="btn btn-primary" data-toggle="collapse" href="#{{str_replace(' ','','localgovernment')}}" role="button" aria-expanded="false" aria-controls="minister">Local Government</a>
        ...
        <div class="row">
            ...
            @foreach($positions as $position)
                @if($position->name == "Local Government" || $position->name == "Chairman" )
                    <div class="col-sm-12 pull-right mx-auto">
                        <div class="team-member collapse multi-collapse" id="{{str_replace(' ','',strtolower($position->name))}}">
                            {{--@if($position->name == 'Local Government' )--}}
                            {{--<div class="col-md-12 my-2 mx-auto">--}}
                            @foreach($lgas as $lga)
                                <a class="btn btn-primary" data-toggle="collapse" href="#{{str_replace(' ','',strtolower($lga->name))}}" role="button" aria-expanded="false" aria-controls="minister">{{ $lga->name }}</a>
                            @endforeach
                            {{--</div>--}}
                            {{--@endif--}}
                        </div>
        ...
        <div class="row">
            ...
            @foreach($officials as $official)
                @if($official->position->name == "Chairman" || $official->position->name == "Vice Chairman")
                    <div class="col-sm-6 mx-auto">
                        <div class="team-member collapse multi-collapse" id="{{str_replace(' ','',strtolower($official->lga->name))}}">
                            <a href="#" data-toggle="modal" data-target="#profile-{{ $official->id }}"><img class="mx-auto rounded-circle" src="{{ asset($official->photo) }}" alt=""></a>
                            <h4>{{ $official->name }}</h4>
                            <p class="text-muted">{{ $official->position->name }}</p>
                            <ul class="list-inline social-buttons">
